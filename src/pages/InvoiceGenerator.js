...
import { generateInvoice } from '../services/aiWriterApi';
...
function InvoiceGenerator() {
  ...
  const handleGenerate = async (e) => {
    ...
    if (!businessName.trim()) {
      setError('Please enter your business or sender name.');
      return;
    }

    if (!clientName.trim()) {
      setError('Please enter the client or bill-to name.');
      return;
    }

    if (!items.trim()) {
      setError('Please list the items or services for the invoice.');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-cream-50">
      <ToolNavbar toolName="AI Invoice Generator" />
      ...
      <main className="section-container py-8 sm:py-12">
        <div className="mx-auto max-w-4xl">
          <div className="mb-8">
            ...
            <h1 className="mt-4 text-3xl font-extrabold text-stone-900 sm:text-4xl">AI Invoice Generator</h1>
            <p className="mt-2 text-base text-stone-500">
              Create professional invoices with itemized line items, tax, and totals — ready to copy and send.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <form onSubmit={handleGenerate} className="space-y-5">
              <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-card">
                <label htmlFor="businessName" className="block text-sm font-bold text-stone-700">
                  Your Business Name
                </label>
                <input
                  id="businessName"
                ...
                <label htmlFor="clientName" className="mt-5 block text-sm font-bold text-stone-700">
                  Client Name
                </label>
                <input
                  id="clientName"
                ...
                <div className="mt-5 grid gap-5 sm:grid-cols-2">
                  <div>
                    <label htmlFor="currency" className="block text-sm font-bold text-stone-700">
                      Currency
                    </label>
                    <select
                      id="currency"
                  ...
                  <div>
                    <label htmlFor="taxRate" className="block text-sm font-bold text-stone-700">
                ...
                <div className="mt-5 grid gap-5 sm:grid-cols-2">
                  <div>
                    <label htmlFor="invoiceDate" className="block text-sm font-bold text-stone-700">
                      Invoice Date <span className="font-normal text-stone-400">(optional)</span>
                    </label>
                    <input
                      id="invoiceDate"
                      type="text"
                  ...
                  <div>
                    <label htmlFor="dueDate" className="block text-sm font-bold text-stone-700">
                ...
                <label htmlFor="items" className="mt-5 block text-sm font-bold text-stone-700">
                  Items or Services
                </label>
                <textarea
                  id="items"
                  ...
                  rows={5}
                  placeholder="List each item with quantity and price, e.g.&#10;Website Design - 1 x $1500&#10;Logo Design - 1 x $500&#10;Monthly Hosting - 3 x $25"
                ...
                <label htmlFor="paymentTerms" className="mt-5 block text-sm font-bold text-stone-700">
                  Payment Terms <span className="font-normal text-stone-400">(optional)</span>
                </label>
                <input
                  id="paymentTerms"
                  type="text"
                  ...
                  placeholder="e.g. Net 30, Bank transfer"
                  className="mt-2 w-full rounded-xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm text-stone-800 placeholder:text-stone-400 focus:border-violet-400 focus:outline-none focus:ring-2 focus:ring-violet-100"
                />

                <label htmlFor="notes" className="mt-5 block text-sm font-bold text-stone-700">
              ...
              <div className="min-h-[320px] rounded-xl border border-stone-100 bg-stone-50 p-4">
                {loading ? (
                  <div className="flex h-full min-h-[280px] flex-col items-center justify-center text-stone-400">
                    ...
                    <p className="text-sm font-medium">AI is building your invoice...</p>
                  </div>
                ) : output ? (
                  ...
                  <div className="flex h-full min-h-[280px] flex-col items-center justify-center text-center text-stone-400">
                    ...
                    <p className="text-sm">Your generated invoice will appear here</p>
                  </div>
                )}
              </div>
            </div>
