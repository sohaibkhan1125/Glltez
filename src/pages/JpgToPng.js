...
import { convertJpgToPng, downloadFile } from '../services/mergePdfApi';
...
function JpgToPng() {
  ...
  const handleConvert = async (e) => {
    ...
    try {
      ...
      setSuccess('JPG converted to PNG successfully! Download your file below.');
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-cream-50">
      <ToolNavbar toolName="JPG to PNG" />
      ...
      <main className="section-container py-8 sm:py-12">
        <div className="mx-auto max-w-3xl">
          <div className="mb-8">
            ...
            <h1 className="mt-4 text-3xl font-extrabold text-stone-900 sm:text-4xl">JPG to PNG</h1>
