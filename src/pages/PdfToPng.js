...
import { convertPdfToPng, downloadFile } from '../services/mergePdfApi';
...
function PdfToPng() {
  ...
  const handleConvert = async (e) => {
    ...
    try {
      const conversion = await convertPdfToPng(file, { pageRange, resolution });
  ...
  return (
    <div className="min-h-screen bg-cream-50">
      <ToolNavbar toolName="PDF to PNG" />
      ...
      <main className="section-container py-8 sm:py-12">
        <div className="mx-auto max-w-3xl">
          <div className="mb-8">
            ...
            <h1 className="mt-4 text-3xl font-extrabold text-stone-900 sm:text-4xl">PDF to PNG</h1>
            <p className="mt-2 text-base text-stone-500">
              Convert PDF pages to high-quality PNG images with transparency support. Multi-page PDFs are packaged into a ZIP file.
            </p>
          </div>
