...
import { convertJpgToWebp, downloadFile } from '../services/mergePdfApi';
...
function JpgToWebp() {
  ...
  const handleConvert = async (e) => {
    ...
    if (!file) {
      setError('Please select a JPG image to convert.');
      return;
    }
    ...
    try {
      ...
      setSuccess('JPG converted to WebP successfully! Download your file below.');
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-cream-50">
      <ToolNavbar toolName="JPG to WebP" />
      ...
      <main className="section-container py-8 sm:py-12">
        <div className="mx-auto max-w-3xl">
          <div className="mb-8">
            ...
            <h1 className="mt-4 text-3xl font-extrabold text-stone-900 sm:text-4xl">JPG to WebP</h1>
            <p className="mt-2 text-base text-stone-500">
              Convert JPG images to modern WebP format for smaller file sizes and faster web loading.
            </p>
          </div>
